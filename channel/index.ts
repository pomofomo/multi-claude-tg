...
const server = new Server(
  { name: "trd-channel", version: "0.1.0" },
  {
    ...
    instructions: [
      ...
      "3. ASK QUESTIONS: If the request is ambiguous or you need clarification, stop and ask questions via reply before proceeding. Do not guess at unclear requirements.",
      "4. PARALLEL EXECUTION: When you receive a large, clear, prescriptive spec or document with well-defined tasks and no ambiguity, use ultrawork (parallel execution) to complete it faster. Trigger this by invoking /oh-my-claudecode:ultrawork if available.",
    ].join("\n"),
  },
);
